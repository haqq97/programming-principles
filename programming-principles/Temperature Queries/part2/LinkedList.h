...
public:
	...
	//computes the average temperature for a given location and a range of years
	double AVG(std::string id, int year1, int year2);

	//finds the most common rounded temperature for a given location and a range of years
	int MODE(std::string id, int year1, int year2);
